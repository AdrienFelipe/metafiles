...
class AskAgent(Action):
    ...
    description = (
        "Ask a specialized agent to respond to the task by text. "
        "Choose this if the task requires specialized knowledge beyond general coding or logical reasoning."
    )
