...
def test_choose_agent_callbacks(logger: IExecutionLogger, prompt_context: IPromptContext):
    task = Task("test", "test")
    prompt = PromptFactory.choose_agent(task, prompt_context)
